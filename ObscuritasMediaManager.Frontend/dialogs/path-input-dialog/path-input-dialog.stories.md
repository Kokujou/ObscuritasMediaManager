...
export default {
    title: 'PathInputDialog',
    component: 'path-input-dialog',
...
function showPathInputDialog() {
    var dialog = PathInputDialog.show();
    dialog.addEventListener('decline', () => dialog.remove());
    dialog.addEventListener('accept', (e) => console.log(e.detail));
}

export const Multiple = () => html`
    <page-routing>
        <input type="button" @click="${() => showPathInputDialog()}" value="Klicken zum Öffnen" />
    </page-routing>
`;
```
