...
import { withKnobs, text, select, number } from 'storybook-prebuilt/addon-knobs';
...
export const Multiple = () => html`
    ...
    <page-routing>
        <dual-slider .steps="${number('Steps', 3)}" @valueSpanChanged="${(e) => console.log(e.detail)}"></dual-slider>
    </page-routing>
`;
```
