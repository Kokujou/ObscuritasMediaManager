...
namespace ObscuritasMediaManager.Backend.Migrations
{
    ...
    [Migration("20241219171212_AddConcatenateKeyForIngredients")]
    partial class AddConcatenateKeyForIngredients
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ObscuritasMediaManager.Backend.Models.RecipeIngredientMappingModel", b =>
                {
                    ...
                    b.HasKey("RecipeId", "IngredientName", "GroupName", "Order");
            ...
            modelBuilder.Entity("ObscuritasMediaManager.Backend.Models.RecipeIngredientMappingModel", b =>
                {
                    ...
                    b.OwnsOne("ObscuritasMediaManager.Backend.Models.MeasurementUnit", "Unit", b1 =>
                        {
                            b1.Property<Guid>("RecipeIngredientMappingModelRecipeId")
                                .HasColumnType("TEXT");

                            b1.Property<string>("RecipeIngredientMappingModelIngredientName")
                                .HasColumnType("TEXT");

                            b1.Property<string>("RecipeIngredientMappingModelGroupName")
                                .HasColumnType("TEXT");

                            b1.Property<int>("RecipeIngredientMappingModelOrder")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("RecipeIngredientMappingModelRecipeId", "RecipeIngredientMappingModelIngredientName", "RecipeIngredientMappingModelGroupName", "RecipeIngredientMappingModelOrder");

                            b1.ToTable("RecipeIngredientMapping");

                            b1.WithOwner()
                                .HasForeignKey("RecipeIngredientMappingModelRecipeId", "RecipeIngredientMappingModelIngredientName", "RecipeIngredientMappingModelGroupName", "RecipeIngredientMappingModelOrder");
                        });
